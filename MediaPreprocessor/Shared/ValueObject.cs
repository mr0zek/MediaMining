...
{
  public abstract class ValueObject : IEqualityComparer, IEquatable<ValueObject>, IComparable<ValueObject>
  {
    ...
    {
      var v1 = string.Join("_", GetValues().Select(f => f.ToString()));
      
      var v2 = string.Join("_", other.GetValues().Select(f => f.ToString()));
